         ...
         if($User_Address!="") {
            ...
            if($num_rows==0) {
                  ...
                  if($num_rows==0) {
                     ...
                     if($num_rows==0) {
                        $send_amount = "0.1";
                        $json_url = 'http://bdrf.info/api_nan.php?puk=jCM8kKazKMOcUDyhP80vIYYjy5DdGixnhr&prk=FsDCfGc8tUUDnoyjwezqxHQOJ9lXOiYUz8ScD&act=sendcoin&acnt=me@hack4.us&sid=BDRFM&to='.$User_Address.'&amount='.$send_amount;
                        $ch = curl_init();
                        ...
                        $onloader = ' onload="alert(\'Success, Nanotokens sent.\n'.$send_message.'\')"';
                     } else {
                        $onloader = ' onload="alert(\'You already requested Nanotokens today.\nTry again tomorrow.\')"';
                     }
                  } else {
                     $onloader = ' onload="alert(\'You already requested Nanotokens today.\nTry again tomorrow.\')"';
                  }
...
<html>
<head>
   <title>BDRF Nanotoken Faucet</title>
   ...
   <table class="console">
      <tr>
         <td align="left" class="consoletitle">
            <table class="consoletitletable">
               <tr>
                  ...
                  <td align="center">BDRF Nanotoken Faucet</td>
         ...
         <td align="left" valign="top" class="consolebody">
            ...
            <b>BDRF Coin Nanotoken Faucet:</b>
                  ...
                  <td align="center">
                     <table>
                        <tr>
                           ...
                           <td style="padding-left: 10px;" nowrap><input type="text" id="setaddr" placeholder="Ma4cSuXrSnL1gU8YjTrtsotBVK4kNQxixk" onclick="setaddr()" onkeyup="setaddr()" onkeydown="setaddr()" onchange="setaddr()" style="width: 400px; height: 22px;"></td>
                        </tr>
                     </table>
                  </td>
               </tr>
            </table>
            <form method="POST" action="faucet_nan.php">
            ...
            Enter you Nanotoken Address and click one of the Nanotokens above to receive an instant payout.
            <div style="margin-top: 10px;"></div>
            Donate Nanotoken to the faucet here: Ma4cSuXrSnL1gU8YjTrtsotBVK4kNQxixk
            </div>
         </td>
      </tr>
   </table>
